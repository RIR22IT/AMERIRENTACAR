            ...
            <div>
                <div style="overflow-x:auto;">
                    <table>
                        ...
                        $query = "SELECT * FROM weddingrates WHERE category = 'LUXARY CARS'";
                        ...
                        if (mysqli_num_rows($data) > 0) {
                            while ($row = mysqli_fetch_assoc($data)) {
                                ...
                                $towhourand30Km = $row['2hourand30Km'];
                                $fourhourand90Km = $row['4hourand40Km'];
                                $eighthourand80Km = $row['8hourand80Km'];
                                $excessHours = $row['excessHours'];
                                $excessMileage = $row['excessMileage'];
                        ?>
                                <tr>
                                    <td><?php echo $vehicle ?></td>
                                    <td><?php echo $towhourand30Km ?></td>
                                    <td><?php echo $fourhourand90Km ?></td>
                                    <td><?php echo $eighthourand80Km ?></td>
                                    <td><?php echo $excessHours ?></td>
                        ...
                        <?php
                        include('./database/connection.php');
                        $query = "SELECT * FROM weddingrates WHERE category = 'VINTAGE & CLASSIC CARS'";
                        $data = mysqli_query($db, $query) or die('error');
                        ...
                        <?php
                        include('./database/connection.php');
                        $query = "SELECT * FROM weddingrates WHERE category = 'PREMIUM CARS'";
                        $data = mysqli_query($db, $query) or die('error');

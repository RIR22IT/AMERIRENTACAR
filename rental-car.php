                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href='<?php echo $img ?>'>
                                            <img class="img-responsive"
                                                src='<?php echo $img ?>' alt="foto" />
                                        </a><span class="b-goods-1__price hidden-th">$<?php echo $rental; ?> Day
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header"><a class="b-goods-1__choose hidden-th"
                                                href="listing-1.html"></a>
                                            <h2 class="b-goods-1__name"><a href="car-details.html"><?php echo $make; ?>
                                                </a></h2>
                                        </div>

                                        <span
                                            class="b-goods-1__price_th text-primary visible-th">$<?php echo $rental; ?>
                                        </span>
                                            ...
                                            <div class="collapse in" id="desc-2">
                                                <ul class="b-goods-1__desc list-unstyled">
                                                    ...
                                                    <li class="b-goods-1__desc-item"><span
                                                            class="hidden-th"></span><?php echo $year; ?></li>
                                        ...
                                        <div class="b-goods-1__section hidden-th">
                                            ...
                                            <div class="collapse" id="list-2">
                                                <ul class="b-goods-1__list list list-mark-5">
                                                    <li class="b-goods-1__list-item">Model: <?php echo $model ?></li>
                                                    <li class="b-goods-1__list-item">Audio Controls on:
                                                        <?php echo $musicOn; ?>
                                                    </li>
                                                    <li class="b-goods-1__list-item">Number of passengers:
                                                        <?php echo $passenger ?></li>
                                                    <li class="b-goods-1__list-item">Number of doors: <?php echo $door; ?></li>
                                                    <li class="b-goods-1__list-item">A/C : <?php echo $ac ?></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>

    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <center>
                    <h1 class="h3 mb-1 text-gray-800">View With Driver Rates</h1>
                </center><br>
                ...
                <center>
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <?php
                            $i   = 1;
                            $qry = "select * from withdriverrates";
                            $run = $db->query($qry);
                            if ($run->num_rows > 0) {
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editWithDriverDetails.php?edit=<?php echo $row['id']; ?>" class="edit_btn"><i class="fas fa-edit" style="color:grey"></i></a>
                                            &nbsp; &nbsp; &nbsp; &nbsp;
                                            <a href="WithDriver_php_code.php?del=<?php echo $row['id']; ?>" class="del_btn"><i class="fa fa-trash" style="color:grey"></i></a>
                                        </td>
                                    </tr>

...
if (isset($_GET['edit'])) {
  $id = $_GET['edit'];
  $update = true;
  $record = mysqli_query($db, "SELECT * FROM selfdriverates WHERE id=$id");
  if ($record->num_rows > 0) {
    while ($n = $record->fetch_assoc()) {
      $vehicle = $n['vehicle'];
      $category = $n['category'];
      $ratePerMonth = $n['ratePerMonth'];
      $ratePerWeek = $n['ratePerWeek'];
      ...
      <div id="content">
        ...
        <body>
          ...
          <div class="container-fluid" style="width: 1300px;">
            <!-- Page Heading -->
            <center>
              <h1 class="h3 mb-1 text-gray-800">Update Self Driver Rates</h1>
            </center>

            <form method="post" action="viewSelfDriver.php" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-md-offset-1 col-md-6"><br>
                  ...
                  <div class="col-15">
                    ...
                    <input type="text" name="ratePerMonth" class="form-control" value="<?php echo $ratePerMonth; ?>" required>
                  </div><br>

                  <div class="col-15">
                    <label>Rate Per Week</label>
                    <input type="text" name="ratePerWeek" class="form-control" value="<?php echo $ratePerWeek; ?>" required>
                  </div><br>
                ...
                <div class="col-md-offset-1 col-md-6" style="bottom: -48px;">
                  <div class="col-15">
                    <select class="form-control" id="category" name="category" style="height: 50px;">
                      ...
                      <option value="General Cars" <?php
                                                    if ($category == 'General Cars') {
                                                      echo "selected";
                                                    }
                                                    ?>>General Cars</option>
                      <option value="Premium Cars" <?php
                                                    ...
                                                    ?>>Premium Cars</option>
                      <option value="Semi Luxury Cars" <?php
                                                        if ($category == 'Semi Luxury Cars') {
                                                          echo "selected";
                                                        }
                                                        ?>>Semi Luxury Cars</option>
                      <option value="Vans" <?php
                                            if ($category == 'Vans') {
                                              echo "selected";
                                            }
                                            ?>>Vans</option>
                      <option value="4WD" <?php
                                          if ($category == '4WD') {
                                            echo "selected";
                                          }
                                          ?>>4WD</option>

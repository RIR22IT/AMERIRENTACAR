...
<?php include('../admin/withDriver_php_code.php'); ?>
...
if (isset($_GET['edit'])) {
  $id = $_GET['edit'];
  $update = true;
  $record = mysqli_query($db, "SELECT * FROM withdriverrates WHERE id=$id");
      ...
      <div id="content">
        ...
        <body>
          ...
          <div class="container-fluid" style="width: 1300px;">
            <!-- Page Heading -->
            <center>
              <h1 class="h3 mb-1 text-gray-800">Update With Driver Rates</h1>
            </center>
            ...
            <form method="post" action="viewWithDriver.php" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-md-offset-1 col-md-6"><br>
                  ...
                  <div class="col-15">
                    <label>Per Day</label>
                    <input type="text" name="perDay" class="form-control" value="<?php echo $perDay; ?>" required>
                  </div><br>
                ...
                <div class="col-md-offset-1 col-md-6" style="bottom: -48px;">
                  <div class="col-15">
                    <select class="form-control" id="category" name="category" style="height: 50px;">
                      <option selected disabled="disabled">Categories</option>
                      <option value="Luxury Cars (100 KMS PER DAY)" <?php
                                                                    if ($category == 'Luxury Cars (100 KMS PER DAY)') {
                                                                      echo "selected";
                                                                    }
                                                                    ?>>Luxury Cars (100 KMS PER DAY)</option>
                      <option value="Luxury Cars (8 HOURS 80 KM PER DAY)" <?php
                                                                          if ($category == 'Luxury Cars (8 HOURS 80 KM PER DAY)') {
                                                                            echo "selected";
                                                                          }
                                                                          ?>>Luxury Cars (8 HOURS 80 KM PER DAY)</option>
                      <option value="Luxury Buses" <?php
                                                    if ($category == 'Luxury Buses') {
                                                      echo "selected";
                                                    }
                                                    ?>>Luxury Buses</option>
                      <option value="Luxury Vans" <?php
                                                  if ($category == 'Luxury Vans') {
                                                    echo "selected";
                                                  }
                                                  ?>>Luxury Vans</option>
                      <option value="4WD Vehicles" <?php
                                                    if ($category == '4WD Vehicles') {
                                                      echo "selected";
                                                    }
                                                    ?>>4WD Vehicles</option>
                    </select>
                  ...
                  <div class="col-15">
                    ...
                    <input type="text" name="ExcessMileage" class="form-control" value="<?php echo $ExcessMileage; ?>" required>
                  </div><br>

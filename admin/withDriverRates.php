                    ...
                    <form method="post" action="viewWithDriver.php" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-offset-1 col-md-6"><br>
                                ...
                                <div class="col-15">
                                    <label>Per Day</label>
                                    <input type="text" name="perDay" class="form-control" value="" required>
                                </div><br>
                            ...
                            <div class="col-md-offset-1 col-md-6" style="bottom: -48px;">
                                <div class="col-15">
                                    <select class="form-control" id="category" name="category" style="height: 50px;">
                                        ...
                                        <option value="Luxury Cars (100 KMS PER DAY)">Luxury Cars (100 KMS PER DAY)</option>
                                        <option value="Luxury Cars (8 HOURS 80 KM PER DAY)">Luxury Cars (8 HOURS 80 KM PER DAY)</option>
                                        <option value="Luxury Buses">Luxury Buses</option>
                                        <option value="Luxury Vans">Luxury Vans</option>
                                        <option value="4WD Vehicles">4WD Vehicles</option>
                                    </select>
                                </div><br>

        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width: 1300px;">
                    <!-- Page Heading -->
                    <center>
                        <h1 class="h3 mb-1 text-gray-800">Add Self Driver Rates</h1>
                    </center>
                    ...
                    <form method="post" action="viewSelfDriver.php" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-offset-1 col-md-6"><br>
                                ...
                                <div class="col-15">
                                    <label>Vehicle (100KM)</label>
                                    <input type="text" name="vehicle" class="form-control" value="" required>
                                </div><br>

                                <div class="col-15">
                                    <label>Rate Per Month</label>
                                    <input type="text" name="ratePerMonth" class="form-control" value="" required>
                                </div><br>

                                <div class="col-15">
                                    <label>Rate Per Week</label>
                                    <input type="text" name="ratePerWeek" class="form-control" value="" required>
                                </div><br>
                            ...
                            <div class="col-md-offset-1 col-md-6" style="bottom: -48px;">
                                <div class="col-15">
                                    <select class="form-control" id="category" name="category" style="height: 50px;">
                                        ...
                                        <option value="General Cars">General Cars</option>

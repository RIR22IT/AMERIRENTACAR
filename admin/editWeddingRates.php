                            ...
                            <div class="row">
                                ...
                                <div class="col-md-offset-1 col-md-6">
                                    ...
                                    <div class="col-15">
                                        ...
                                        <input type="text" name="2hourand30Km" class="form-control"
                                            value="<?php echo $twohourand30Km; ?>" required>
                                    </div><br>

                                    <div class="col-15">
                                        <label>4 Hours & 40kms</label>
                                        <input type="text" class="form-control" name="4hourand40Km"
                                            value="<?php echo $fourhourand40Km; ?>" required>
                                    </div><br>
                                ...
                                <div class="col-md-offset-1 col-md-6" style="bottom: -22px;">
                                    <div class="col-15">
                                        ...
                                        <input type="text" class="form-control" name="8hourand80Km"
                                            value="<?php echo $eighthourand80Km; ?>" required>
                                    </div><br>
                                    <div class="col-15">
                                        <label>Excess Hours</label>
                                        <input type="text" class="form-control" name="excessHours"
                                            value="<?php echo $excessHours; ?>" required>
                                    </div><br>

                                    <div class="col-15">
                                        <label>Excess Mileage</label>
                                        <input type="text" class="form-control" name="excessMileage"
                                            value="<?php echo $excessMileage; ?>" required>
                                    </div><br>

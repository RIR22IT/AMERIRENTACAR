...
$subTot = 0;
if (0 < $qty && $qty < 7) {
    $subTot = $subTot + ($qty * $rental);
} else if (7 <= $qty && $qty <= 29) {
    $subTot = $subTot +  ($qty * ($week / 7));
} else {
    $subTot = $subTot + ($qty * ($month / 30));
}
                                        ...
                                        <div class="widget widget-newsletter section-sidebar">
                                            ...
                                            <div class="widget-content">
                                                <form class="form-sidebar" id="newsletter-form" style="width: 500px;" action="userform.php" method="GET">
                                                    ...
                                                    <input type="hidden" name="pickLoc" value="<?php echo $pickupLoc ?>">
                                                    <input type="hidden" name="dropLoc" value="<?php echo $dropLoc ?>">
                                                    <input type="hidden" name="subTot" value="<?php echo $subTot ?>">
                                                    <input type="hidden" name="localprice" value="<?php echo $localPrice ?>">

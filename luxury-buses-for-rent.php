...
<head>
    ...
    <title>AMERIRENTACAR | LUXURY BUSES FOR RENT IN SRI LANKA</title>
                                ...
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images"
                                            href="./images//luxury-buses-for-rent//Toyota-Coaster.jpg">
                                            <img class="img-responsive"
                                                src="./images//luxury-buses-for-rent//Toyota-Coaster.jpg" alt="foto"
                                                style="width: 324px;" />
                                        </a>
                                    </div>

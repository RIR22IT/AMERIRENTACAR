...
<body>
    ...
    <div class="l-theme animated-css" data-header="sticky" data-header-top="200" data-canvas="container">
        ...
        <div class="l-theme animated-css" data-header="sticky" data-header-top="200" data-canvas="container">
            ...
            <!--                            class="main-slider__btn-label">Starting</span><span-->
                            ...
                            <div class="goods-group-2 list-goods list-goods_th">
                                    ...
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images//rent_general_cars//HondaFitHybrid.jpg">
                                                <img class="img-responsive"
                                                    src="./images//rent_general_cars//HondaFitHybrid.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">
                                            ...
                                            <div class="b-goods-1__section">
                                                <h3 class="b-goods-1__title" data-toggle="collapse"
                                                    data-target="#desc-1">Highlights</h3>
                                                <div class="collapse in" id="desc-1">
                                                    <a class="btn btn-dark" href="self-drive-rates.php">SELF DRIVE
                                                        RATES</a><a class="btn btn-primary"
                                                        href="with-drive-rates.php">WITH DRIVER RATES</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <section class="b-goods-1 b-goods-1_mod-a">
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images//rent_general_cars//KiaPicanto.jpg">
                                                <img class="img-responsive"
                                                    src="./images//rent_general_cars//KiaPicanto.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">
                                ...
                                <section class="b-goods-1 b-goods-1_mod-a">
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images//rent_general_cars//PeroduaAxia.jpg">
                                                <img class="img-responsive"
                                                    src="./images//rent_general_cars//PeroduaAxia.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">
                                ...
                                <section class="b-goods-1 b-goods-1_mod-a">
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images//rent_general_cars//SuzukiAlto800.jpg">
                                                <img class="img-responsive"
                                                    src="./images//rent_general_cars//SuzukiAlto800.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">
                                ...
                                <section class="b-goods-1 b-goods-1_mod-a">
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images//rent_general_cars//SuzukiAltoK10.jpg">
                                                <img class="img-responsive"
                                                    src="./images//rent_general_cars//SuzukiAltoK10.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">
                                ...
                                <section class="b-goods-1 b-goods-1_mod-a">
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images//rent_general_cars//SuzukiBaleno.jpg">
                                                <img class="img-responsive"
                                                    src="./images//rent_general_cars//SuzukiBaleno.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">
                                ...
                                <section class="b-goods-1 b-goods-1_mod-a">
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images//rent_general_cars//SuzukiCelerio.jpg">
                                                <img class="img-responsive"
                                                    src="./images//rent_general_cars//SuzukiCelerio.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">
                                ...
                                <section class="b-goods-1 b-goods-1_mod-a">
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images//rent_general_cars//SuzukiWagonR.jpg">
                                                <img class="img-responsive"
                                                    src="./images//rent_general_cars//SuzukiWagonR.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">
                                ...
                                <section class="b-goods-1 b-goods-1_mod-a">
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images//rent_general_cars//ToyotaAquaPriusC.jpg">
                                                <img class="img-responsive"
                                                    src="./images//rent_general_cars//ToyotaAquaPriusC.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">
                                ...
                                <section class="b-goods-1 b-goods-1_mod-a">
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images//rent_general_cars//ToyotaPixisHybrid.jpg">
                                                <img class="img-responsive"
                                                    src="./images//rent_general_cars//ToyotaPixisHybrid.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">
                                ...
                                <section class="b-goods-1 b-goods-1_mod-a">
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images//rent_general_cars//ToyotaVitz2016.jpg">
                                                <img class="img-responsive"
                                                    src="./images//rent_general_cars//ToyotaVitz2016.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">
                                ...
                                <section class="b-goods-1 b-goods-1_mod-a">
                                    <div class="row">
                                        <div class="b-goods-1__img">
                                            <a class="js-zoom-images"
                                                href="./images/rent_general_cars//ToyotaVivaAxia.jpg">
                                                <img class="img-responsive"
                                                    src="./images/rent_general_cars//ToyotaVivaAxia.jpg" alt="foto"
                                                    style="width: 324px;" />
                                            </a>
                                        </div>
                                        <div class="b-goods-1__inner">

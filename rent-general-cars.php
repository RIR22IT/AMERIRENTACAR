...
<body>
    ...
    <div class="l-theme animated-css" data-header="sticky" data-header-top="200" data-canvas="container">
        ...
        <div class="section-title-page area-bg area-bg_dark area-bg_op_70">
            <div class="area-bg__inner">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <h1 class="b-title-page bg-primary_a">RENT GENERAL CARS IN SRI LANKA</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">RENT GENERAL CARS IN SRI LANKA</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-40" style="width: 1300px;">
                    <main class="l-main-content">
                        ...
                        <div class="goods-group-2 list-goods list-goods_th">
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images//rent_general_cars//HondaFitHybrid.jpg">
                                            <img class="img-responsive" src="./images//rent_general_cars//HondaFitHybrid.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Honda Fit Hybrid</h2>
                                        </div>
                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images//rent_general_cars//KiaPicanto.jpg">
                                            <img class="img-responsive" src="./images//rent_general_cars//KiaPicanto.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Kia Picanto 2016</h2>
                                        </div>
                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images//rent_general_cars//PeroduaAxia.jpg">
                                            <img class="img-responsive" src="./images//rent_general_cars//PeroduaAxia.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Perodua(Daihatsu) Axia</h2>
                                        </div>
                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images//rent_general_cars//SuzukiAlto800.jpg">
                                            <img class="img-responsive" src="./images//rent_general_cars//SuzukiAlto800.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Suzuki Alto 800</h2>
                                        </div>
                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images//rent_general_cars//SuzukiAltoK10.jpg">
                                            <img class="img-responsive" src="./images//rent_general_cars//SuzukiAltoK10.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Suzuki Alto K10 Auto</h2>
                                        </div>
                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images//rent_general_cars//SuzukiBaleno.jpg">
                                            <img class="img-responsive" src="./images//rent_general_cars//SuzukiBaleno.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Suzuki Baleno</h2>
                                        </div>
                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images//rent_general_cars//SuzukiCelerio.jpg">
                                            <img class="img-responsive" src="./images//rent_general_cars//SuzukiCelerio.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Suzuki Celerio</h2>
                                        </div>
                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images//rent_general_cars//SuzukiWagonR.jpg">
                                            <img class="img-responsive" src="./images//rent_general_cars//SuzukiWagonR.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Suzuki Wagon R Hybrid</h2>
                                        </div>
                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images//rent_general_cars//ToyotaAquaPriusC.jpg">
                                            <img class="img-responsive" src="./images//rent_general_cars//ToyotaAquaPriusC.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Toyota Aqua Prius C</h2>
                                        </div>
                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images//rent_general_cars//ToyotaPixisHybrid.jpg">
                                            <img class="img-responsive" src="./images//rent_general_cars//ToyotaPixisHybrid.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Toyota Pixis Hybrid</h2>
                                        </div>
                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images//rent_general_cars//ToyotaVitz2016.jpg">
                                            <img class="img-responsive" src="./images//rent_general_cars//ToyotaVitz2016.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Toyota Vitz 2016</h2>
                                        </div>
                            ...
                            <section class="b-goods-1 b-goods-1_mod-a">
                                <div class="row">
                                    <div class="b-goods-1__img">
                                        <a class="js-zoom-images" href="./images/rent_general_cars//ToyotaVivaAxia.jpg">
                                            <img class="img-responsive" src="./images/rent_general_cars//ToyotaVivaAxia.jpg" alt="foto" style="width: 324px;" />
                                        </a>
                                    </div>
                                    <div class="b-goods-1__inner">
                                        <div class="b-goods-1__header">
                                            <h2 class="b-goods-1__name">Toyota Viva Axia</h2>
                                        </div>
